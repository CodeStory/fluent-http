...
public class JsonCookieAuthFilterTest {
  private JsonCookieAuthFilter filter;

  @Before
  public void create_filter() {
    filter = new JsonCookieAuthFilter("/secure/", Users.singleUser("admin", "adminftw"), SessionIdStore.inMemory(), ".less", ".css");
  }
  ...
  public void robots_txt_is_public() {
    filter = new JsonCookieAuthFilter("/", Users.singleUser("", ""));

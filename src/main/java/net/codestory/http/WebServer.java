...
public class WebServer {
  ...
  public WebServer startSSL(int port, Path pathCertificate, Path pathPrivateKey) {
    return startSSL(port, Arrays.asList(pathCertificate), pathPrivateKey, null);
  }
  ...
  private class ProxyServer implements Server {

    private volatile boolean authReq = false;
